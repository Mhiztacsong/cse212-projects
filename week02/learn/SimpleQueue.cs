public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue accesses index 1 instead of 0, causing a crash when only one item exists.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue inserts at the front instead of the back, breaking FIFO order.
        ...
        // Defect(s) Found: No defect after fixes. Exception is correctly thrown.
    }
